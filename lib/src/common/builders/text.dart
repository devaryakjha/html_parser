...
final class HtmlTextBuilder extends HtmlWidgetBuilder {
  const HtmlTextBuilder(this.span);

  final InlineSpan span;

  @override
  factory HtmlTextBuilder.fromNode(dom.Node node) {
    final span = _createRecurssiveSpan(node);
    return HtmlTextBuilder(span);
  }
